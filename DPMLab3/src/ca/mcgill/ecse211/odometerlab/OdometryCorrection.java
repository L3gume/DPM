...
public class OdometryCorrection extends Thread {
  ...
  public void run() {
    ...
    while (true) {
      ...
      if (light_level > 0.1 && light_level < 0.5
          && System.currentTimeMillis() - line_detected_time > 3000) {
        ...
        if (line_count > 0 && line_count % 3 != 0) {
          ...
          double cur_theta = (prev_pos[2] + odometer.getTheta()) / 2; // Average with past value to
                                                                      // reduce
