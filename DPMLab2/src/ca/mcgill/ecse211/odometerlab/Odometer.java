...
public class Odometer extends Thread {
	...
	public void run() {
		...
		while (true) {
			...
			int phi_l = leftMotor.getTachoCount() - getLeftMotorTachoCount(); // Variation of rotation of right wheel, in degrees
			int phi_r = rightMotor.getTachoCount() - getRightMotorTachoCount(); // Variation of rotation of right wheel, in degrees
